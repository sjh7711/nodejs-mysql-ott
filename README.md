...
![main](https://user-images.githubusercontent.com/69497936/101235745-5f20ff80-370e-11eb-985a-208620293bf7.png)

# 프로젝트 목표

> 넷플리스나 왓챠와 같은 OTT서비스를 클론 코딩 및 개선하여 영화 정보 사이트를 구현한다.
